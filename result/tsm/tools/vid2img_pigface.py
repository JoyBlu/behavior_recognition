...
def vid2jpg(file_name, class_path, dst_class_path):
    ...
    try:
        ...
        return
    cmd = 'ffmpeg -i \"{}\" -threads 1 -vf scale=-1:320 -q:v 0 \"{}/img_%05d.jpg\"'.format(video_file_path, dst_directory_path)
    # print(cmd)
...
if __name__ == "__main__":
    dir_path = 	'/media/lan/TOSHIBA EXT/video_data'		#sys.argv[1]
    dst_dir_path = '/media/lan/TOSHIBA EXT/video_tmp'		#sys.argv[2]
    '''
