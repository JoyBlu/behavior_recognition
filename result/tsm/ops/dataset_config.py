...
ROOT_DATASET = '/home/ubuntu/usb/video_2s/'  # '/data/jilin/'


def return_ucf101(modality):
    filename_categories = 'video_label/6/pigface_classInd.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'video_frames'
        filename_imglist_train = 'video_label/6/train_videofolder.txt'
        filename_imglist_val = 'video_label/6/val_videofolder.txt'
        prefix = 'img_{:05d}.jpg'
    elif modality == 'Flow':
